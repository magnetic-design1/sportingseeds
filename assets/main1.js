...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.container.style2', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container.style2 > .wrapper > .inner', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
